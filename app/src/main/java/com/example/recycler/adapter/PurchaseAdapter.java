...
import com.example.recycler.viewDashboard.viewPurchase.viewPurchaseDetailActivity;
import com.squareup.picasso.Callback;
import com.squareup.picasso.Picasso;

import java.util.List;

public class PurchaseAdapter extends RecyclerView.Adapter<PurchaseAdapter.viewHolderPurchase> {

    private final List<purchaseModel> modelList;
    private final Context mContext;

    public PurchaseAdapter(List<purchaseModel> modelList, Context mContext) {
    ...
    @NonNull
    @Override
    public viewHolderPurchase onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new viewHolderPurchase(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_purchase, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull PurchaseAdapter.viewHolderPurchase holder, int position) {
        ...
        holder.relativeLayout_click.setOnClickListener(v -> {
            Intent intent = new Intent(mContext, viewPurchaseDetailActivity.class);
            intent.putExtra("model", purchaseModel);
    ...
    static class viewHolderPurchase extends RecyclerView.ViewHolder {
